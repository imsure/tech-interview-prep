class Solution:
    ...
    def findDuplicate2(self, paths):
        ...
        return [*filter(lambda x: len(x) > 1, content2path.values())]


sol = Solution()
print(sol.findDuplicate2(["root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(efgh)"]))
